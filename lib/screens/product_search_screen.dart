...
class ProductSearchScreen extends StatefulWidget {
  ...
  ProductSearchScreen({this.searchKeyword});
  @override
...
class _ProductSearchScreenState extends State<ProductSearchScreen> {
  ...
  final AsyncMemoizer<List<Product>> _memoizerProductBySearchKeyword =
  ...
  Future<List<Product>> _getProductsByCategory() async {
    return this._memoizerProductBySearchKeyword.runOnce(() async {
      var products =
          await _productService.getProductsByKeyword(this.widget.searchKeyword);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Hasil Pencarian : " + this.widget.searchKeyword),
